...
if __name__ == '__main__':
    ...
    parser.add_argument("-mode", default='cal_repeat', type=str)
    parser.add_argument("-result_path", default='../results/results/presum-reddit-1024-bertExtAbs-base/redditExtAbs.128.8000')
