...
export MODEL_PATH=/home/code-base/user_space/saved_models/bertsum/presum-reddit-512-bertExt-base/


python train.py -task ext -mode train \
                          -bert_data_path $BERT_DATA_PATH -ext_dropout 0.1 -model_path $MODEL_PATH \
                          -lr 2e-3 -visible_gpus 0,1,2,3 -report_every 50 -save_checkpoint_steps 1000 \
