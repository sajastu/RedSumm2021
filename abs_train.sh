...
python src/train.py -task abs -mode train \
                ...
                -sep_optim true -lr_bert 0.002 -lr_dec 0.1 -save_checkpoint_steps 50000 \
                -batch_size 30 -test_batch_size 100 -train_steps 1500000 -report_every 100 -accum_count 1 \
