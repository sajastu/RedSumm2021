...
python src/train.py -task abs -mode train \
                ...
                -batch_size 50 -test_batch_size 200 -train_steps 1000000 -report_every 100 -accum_count 1 \
                -use_bert_emb true -use_interval true -warmup_steps_bert 320000 \
                -warmup_steps_dec 10000 -max_pos 512 -visible_gpus 0,1,2,3,4,5,6,7  \
